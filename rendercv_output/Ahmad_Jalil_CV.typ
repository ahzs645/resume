...
#v(-4pt)• Focus on air quality and environmental health
#v(-2pt)#v(-4pt)  // Standard spacing after education entries
#v(design-entries-vertical-space-between-entries)
// Education entry matching LaTeX formatting exactly
...
#v(-4pt)• Minor: Natural Resource Planning and Operations \(Forestry\)
#v(-2pt)• The Lieutenant Governor's Medal for Inclusion, Democracy and Reconciliation
#v(-2pt)#v(-4pt)  // Standard spacing after education entries
