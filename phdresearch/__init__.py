...
class Templates(BaseModelWithoutExtraKeys):
    footer: str = pydantic.Field(
        default="CURRENT_DATE     NAME · Curriculum Vitae     PAGE_NUMBER",
        description=(
...
class PhdresearchTheme(BaseModelWithoutExtraKeys):
    theme: Literal["phdresearch"] = "phdresearch"
